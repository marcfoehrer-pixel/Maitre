...
| **Aktien-Kurzfristprognose** — Dashboard fürs iPhone mit Live-Aktualisierung, Rangliste nach empirisch kalibrierter Aufwärtswahrscheinlichkeit, deutsche und amerikanische Titel; kennwortgeschützt, auch von unterwegs und ganz ohne eigenen Rechner betreibbar | Doppelklick auf `Dashboard starten.command` (macOS) bzw. `.bat` (Windows) — oder per `render.yaml` im Internet betreiben | [`stocks/README.md`](stocks/README.md) |
